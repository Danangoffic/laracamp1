                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{ route('checkout.store', $camp->id) }}" method="POST" class="basic-form">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="card_number" maxlength="16" type="number" class="form-control">
                                </div>
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number" maxlength="3" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" class="w-100 btn btn-primary">Pay Now</button>
                                <p class="text-center subheader mt-4">
                                    <img src="{{ asset('assets/images/ic_secure.svg') }}" alt=""> Your payment is
                                    secure and
                                    encrypted.
                                </p>
                            </form>
